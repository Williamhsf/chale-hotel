# Projeto Inicial
<div align="center">
  <img src="./img/layout.png" width="500px" alt="página inicial"/>
</div>

Este projeto de um site de um Chalé Hotelé uma implementação inicial criada em colaboração com o professor Jorge Sant Ana. Foi desenvolvido como parte do curso **Domine Web - 20 Cursos - HTML5, CSS3, SASS, Bootstrap, JS, ES6, PHP, OO, MySQL, JQuery, MVC, APIs, IONIC e muito mais** disponível na [Udemy](https://www.udemy.com/course/web-completo/).
